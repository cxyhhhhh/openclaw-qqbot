...
- Fixed the `/bot-version` command still returning an outdated GitHub repository URL.
- Synced the default upgrade guide URL in the `upgradeUrl` config documentation.
